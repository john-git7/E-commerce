...
export default function Profile() {
	const [personalDetails, setPersonalDetails] = useState({
		name: "John Ebenezer",
		email: "blazer069@gmail.com",
		phoneNumber: "2585125845",
		avatarUrl: "src/assets/IMG-20250318-WA0009[1].jpg",
	});
	...
	useEffect(() => {
		fetch(
			`http://localhost:5000/api/user/profile?email=${"blazer069@gmail.com"}`,
			{
				method: "GET",
				headers: {
